  ...
  ITA: [
    {
      ...
      items: [
        ...
        "Serbatoio di aspirazione / serbatoio d'olio 20L + 1 sensore di livello massimo",
  ...
  EN: [
    {
      ...
      items: [
        ...
        "Suction receiver / oil reservoir 20L + 1 maximum level sensor",
  ...
  FR: [
    {
      ...
      items: [
        "Réservoir de liquide : 50 litres",
        ...
        "Réservoir d'aspiration / réservoir d'huile 20L + 1 capteur de niveau maximum",
  ...
  DE: [
    {
      ...
      items: [
        ...
        "Saugbehälter / Ölbehälter 20L + 1 Maximalpegelsensor",
